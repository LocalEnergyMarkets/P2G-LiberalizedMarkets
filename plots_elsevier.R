...
ggsave(filename = paste(session_dir, "plots/", "plot_economic_dispatch.pdf", sep = ""), 
       plot = last_plot(), device = "pdf", width = plot_width, height = 4.45, units = "cm", dpi = 150)

ggsave(filename = paste(session_dir, "plots/", "plot_economic_dispatch.png", sep = ""), 
       plot = last_plot(), device = "png", width = plot_width_png, height = 4.45, units = "cm", dpi = 150)
...
ggsave(filename = paste(session_dir, "plots/", "plot_redispatch.pdf", sep = ""), 
       plot = last_plot(), device = "pdf", width = plot_width, height = 5, units = "cm", dpi = 150)

ggsave(filename = paste(session_dir, "plots/", "plot_redispatch.png", sep = ""), 
       plot = last_plot(), device = "png", width = plot_width_png, height = 5, units = "cm", dpi = 150)
...
ggsave(filename = paste(session_dir, "plots/", "plot_mechanism_ptg.pdf", sep = ""), 
       plot = last_plot(), device = "pdf", width = plot_width, height = 10, units = "cm", dpi = 150)

ggsave(filename = paste(session_dir, "plots/", "plot_mechanism_ptg.png", sep = ""), 
       plot = last_plot(), device = "png", width = plot_width_png, height = , units = "cm", dpi = 150)
